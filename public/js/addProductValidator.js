window.addEventListener("load",function(){
   ...
   let inputTalle= document.querySelector("#talle")
   ...
   let errorCategoria= document.querySelector("#errorCategory")
   let errorSexo= document.querySelector("#errorSexo")
   let errorMarca= document.querySelector("#errorMarca")
   let errorTalle= document.querySelector("#errorTalle")
 ...
 inputdescripcion.addEventListener("blur", function(){
    ...
    inputImagenP.addEventListener("blur",function(){
     ...
     inputTalle.addEventListener("blur",function(){
        if(inputTalle.value.length == 0){
        errorTalle.innerText = "Debes ingresar un precio"
        errors = errors++
         }else{
            errorTalle.innerText = ""
            errors = 0
         }
     })
